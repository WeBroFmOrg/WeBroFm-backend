...
from .models import Language, Category, Author, Show, Episode, EpisodeAnalytics, Teaser
...
class ShowSerializer(serializers.ModelSerializer):
    ...
    language_name = serializers.ReadOnlyField(source='language.name', default=None)
    language_code = serializers.ReadOnlyField(source='language.code', default=None)

    class Meta:
        model = Show
        fields = (
            'id', 'title', 'description', 'category', 'author',
            'category_name', 'author_name', 'language', 'language_name', 'language_code',
            'thumbnail',
...
class EpisodeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Episode
        fields = ('id', 'show', 'title', 'description', 'duration_seconds',
                  'sequence_number', 'audio_file_key', 'hls_playlist_key',
                  'audio_file', 'audio_url', 'language', 'language_name', 'language_code',
                  'created_at')
        extra_kwargs = {
...
class TeaserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Teaser
        fields = ('id', 'title', 'image', 'image_url', 'sequence', 'is_active',
                  'is_converted', 'converted_show', 'converted_show_title', 'created_at')
...
class PreloadEpisodeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Episode
        fields = ('id', 'title', 'sequence_number', 'duration_seconds',
                  'audio_file_key', 'hls_playlist_key',
...
class PreloadShowSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'title', 'description', 'thumbnail', 'thumbnail_url',
                  'category_name', 'language_name', 'language_code', 'age_rating')
